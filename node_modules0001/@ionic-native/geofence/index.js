...
var Geofence = (function (_super) {
    ...
    /**
       ...
       * @return {Observable<any>}
       */
    Geofence.prototype.onTransitionReceived = /**
       * Subscribe to get notified when a transition is received
       * @return {Observable<any>}
       */
    function () { return; };
    ...
    /**
       ...
       * @returns {Promise<void>}
       */
    Geofence.prototype.addOrUpdate = /**
       * Adds a new geofence or array of geofences. For geofence object, see above.
       *
       * @returns {Promise<void>}
       */
    function (geofences) { return; };
    /**
    ...
    /**
       ...
       * @returns {Promise<void>}
       */
    Geofence.prototype.remove = /**
       * Removes a geofence or array of geofences. `geofenceID` corresponds to one or more IDs specified when the
       * geofence was created.
       *
       * @returns {Promise<void>}
       */
    function (geofenceId) { return; };
    /**
    ...
    /**
       ...
       * @returns {Observable<any>}
       */
    Geofence.prototype.onNotificationClicked = /**
       * Called when the user clicks a geofence notification. iOS and Android only.
       *
       * @returns {Observable<any>}
       */
    ...
    ], Geofence.prototype, "onTransitionReceived", null);
    __decorate([
        Cordova(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
